...
const char* User::RPL_WELCOME(std::string nick) {std::string message("001 " + nick + " welcome to ft_irc"); return (message.c_str());}
...
const char* User::RPL_JOIN(std::string nick, std::string channel) {std::string message(":" + nick + " JOIN :" + channel); return (message.c_str());}
